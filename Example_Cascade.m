...
amp1.gain = 20;
amp1.NF = 1.5;
amp1.OIP3 = amp1.pout + 10.6;
amp1.name = 'LNA1';

amp2.pout = 0;
amp2.gain = 20;
amp2.NF = 3;
amp2.OIP3 = amp2.pout + 10.6;
amp2.name = 'LNA2';

amp3.pout = 10;
amp3.gain = 20;
amp3.NF = 3;
amp3.OIP3 = amp3.pout + 10.6;
amp3.name = 'LNA3';
...
cascade = {pad1 amp1 amp2 amp3};
cascade = {pad1 amp1 amp2 amp3 converter};
cascade = {amp1 pad1 amp2 amp3 converter};
